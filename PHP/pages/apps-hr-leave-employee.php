...
<head>
    <?php $title = "Leave Manage (Employee)";
                        ...
                        <div class="card-body">
                            <div class="flex items-center gap-3">
                                <div class="btn text-danger bg-danger/10 size-12">
                                    <i data-lucide="file-bar-chart-2" class="size-6"></i>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="flex items-center gap-3">
                                <div class="btn text-info bg-info/10 size-12">
                                    <i data-lucide="anchor" class="size-6"></i>
                                </div>
                                            ...
                                            <tbody class="divide-y divide-default-200">
                                                <tr class="text-default-800 font-normal whitespace-nowrap">
                                                    ...
                                                    <td class="px-3.5 py-2.5 text-end">
                                                        <a href="#" class="btn size-8 bg-primary/20 hover:bg-primary text-primary hover:text-white">
                                                ...
                                                <tr class="text-default-800 font-normal whitespace-nowrap">
                                                    ...
                                                    <td class="px-3.5 py-2.5 flex items-center justify-end gap-2">
                                                        <a href="#" class="btn size-8 bg-default-200 hover:bg-default-600 hover:text-white transition-all text-default-600">
