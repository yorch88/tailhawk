...
<body>
                            ...
                            <div class="card-body">
                                ...
                                <div class="grid grid-cols-1 mb-5">
                                    ...
                                    <div class="flex items-center justify-center bg-transparent border border-dashed rounded-md cursor-pointer dropzone border-default-300 dropzone2">
                                        <div class="fallback">
                                            <i data-lucide="file" type="file" multiple="multiple"></i>
                                        </div>
                                                ...
                                                <div class="py-3 px-4 text-center">
                                                    <div>
                                                        <div class="p-2 mx-auto rounded-md size-14 bg-default-200">
                                                            <i data-dz-thumbnail data-lucide="file" class="block size-7 w-full h-full rounded-md"></i>
                                                        </div>
                                                    </div>
                                                    <div class="pt-3">
                                ...
                                <div class="grid lg:grid-cols-3 grid-cols-1 gap-5 mb-5">
                                    ...
                                    <div class="col-span-1">
                                        ...
                                        <input type="text" id="publishDateTime" class="form-input" placeholder="Select date & time" data-provider="flatpickr" data-date-format="d M, Y" data-enable-time="" required="" readonly="readonly">
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="px-5 py-8 rounded-md bg-info/10">
                                        <img src="/images/product/img-03.png" alt="" class="block mx-auto h-44">
                                    </div>

                                    <div class="mt-3">
                                        <h5 class="mb-2 text-lg text-default-800 font-medium ">$145.99 <small class="font-normal line-through text-default-600">299.99</small></h5>
                                    ...
                                    <div class="flex gap-2 flex-wrap items-center">
                                        <input id="color1" type="checkbox" class="form-checkbox rounded-full text-primary" />
                                        <input id="color2" type="checkbox" class="form-checkbox rounded-full text-danger" />
                                        <input id="color3" type="checkbox" class="form-checkbox rounded-full text-success" />
                                        <input id="color5" type="checkbox" class="form-checkbox rounded-full text-secondary" />
                                    </div>
                                    ...
                                    <div class="grid md:grid-cols-2 grid-cols-1 gap-2 mt-4">
                                        <button class="border border-dashed border-primary bg-transparent btn text-primary hover:bg-primary/10">
                                            Create Product
                                        </button>
    ...
    <script src="/src/scripts/components/dropzone.js" type="module"></script>
