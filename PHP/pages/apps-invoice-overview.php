                        ...
                        <div class="pb-5">
                            <div class="flex flex-wrap justify-between md:gap-0 gap-4 items-center">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <button class="bg-primary text-nowrap text-white btn hover:bg-blue-600" onclick="window.print()"><i data-lucide="save" class="size-4 text-white"></i>Save & Draft</button>
