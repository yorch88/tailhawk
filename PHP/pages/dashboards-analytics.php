...
<body>
            ...
            <main>
                    ...
                    <div class="col-span-1">
                        <div class="grid md:grid-cols-2 grid-cols-1 gap-5">
                            <div class="card bg-success/15 overflow-hidden">
                                <div class="card-body">
                                    <i data-lucide="kanban" class="absolute top-0 size-32 text-success/10 -end-10"></i>
                                    <div class="btn btn-icon size-12 bg-green-800">
                                        <i data-lucide="users" class="size-6 text-green-50"></i>
                                    </div>
                            ...
                            <div class="card bg-danger/15 overflow-hidden">
                                <div class="card-body">
                                    <i data-lucide="list-filter" class="absolute top-0 size-32 text-danger/10 -end-10"></i>
                                    <div class="btn btn-icon bg-danger size-12">
                                        <i data-lucide="cog" class="size-6 text-white"></i>
                                    </div>
                                    <h5 class="mt-5 mb-2 text-lg font-semibold">
                            ...
                            <div class="card bg-secondary/15 overflow-hidden">
                                <div class="card-body">
                                    <i data-lucide="list-filter" class="absolute top-0 size-32 text-secondary/10 -end-10"></i>
                                    <div class="btn btn-icon bg-secondary size-12">
                                        <i data-lucide="coins" class="size-6 text-sky-50"></i>
                                    </div>
                                    <h5 class="mt-5 mb-2 text-lg font-semibold">
                                        <span class="counter-value" data-target="1">0</span>
                                        <span>M</span> <span class="counter-value" data-target="29">0</span>sec</span>
                                    </h5>
                            ...
                            <div class="card bg-info/15 overflow-hidden">
                                <div class="card-body">
                                    <i data-lucide="kanban" class="absolute top-0 size-32 text-info/10 -end-10"></i>
                                    <div class="btn btn-icon bg-info size-12">
                                        <i data-lucide="coins" class="size-6 text-purple-50"></i>
                                    </div>
                                    <h5 class="mt-5 mb-2  text-lg font-semibold">
                    ...
                    <div class="lg:col-span-5 col-span-1">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button type="button" class="btn btn-sm bg-primary/20 text-primary text-nowrap hover:bg-primary hover:text-white">
                                    View More
                ...
                <div class="grid lg:grid-cols-3 grid-cols-1 gap-5 mb-5">
                            ...
                            <div class="flex items-center gap-1.5">
                                ...
                                <div class="hs-tooltip [--placement:top]">
                                    <button type="button" class="hs-tooltip-toggle">
                                        ...
                                        <span class="hs-tooltip-content max-w-80 hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity inline-block absolute invisible z-50 py-1 px-2 bg-default-900 text-xs font-medium text-default-100 rounded-md shadow-2xs" role="tooltip">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="flex items-center gap-1.5">
                                ...
                                <div class="hs-tooltip [--placement:top]">
                                    <button type="button" class="hs-tooltip-toggle">
                                        <i data-lucide="info" class="size-4 text-default-500 mt-2"></i>
                                        <span class="hs-tooltip-content max-w-80 hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity inline-block absolute invisible z-30 py-1 px-2 bg-default-900 text-xs font-medium text-default-100 rounded-md shadow-2xs " role="tooltip">
                        ...
                        <div class="card-body">
                            <div id="satisfactionRate" class="apex-charts"></div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="dailyVisitInsightsChart" class="apex-charts"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="flex gap-3 items-center">
                                ...
                                <button class="btn btn-sm bg-transparent text-primary border border-dashed border-primary hover:bg-primary/20">
                                    ...
                                    <table class="min-w-full divide-y divide-default-200">
                                        <thead class="bg-default-150">
                                            <tr class="text-default-600">
                                                <th scope="col" class="py-3 text-start ps-4">
                                                    <input id="checkbox-all" type="checkbox" class="form-checkbox">
                                                </th>
                                                <th scope="col" class="px-3.5 py-3 text-start text-sm font-medium">Products</th>
                                                <th scope="col" class="px-3.5 py-3 text-start text-sm font-medium">Price</th>
                                                <th scope="col" class="px-3.5 py-3 text-start text-sm font-medium">Income</th>
                                                <th scope="col" class="px-3.5 py-3 text-start text-sm font-medium">Sales</th>
                                                <th scope="col" class="px-3.5 py-3 text-start text-sm font-medium">View</th>
                                                <th scope="col" class="px-3.5 py-3 text-start text-sm font-medium">Click</th>
                                                <th scope="col" class="px-3.5 py-3 text-start text-sm font-medium whitespace-nowrap">Click (%)</th>
                                        ...
                                        <tbody class="divide-y divide-default-200">
                                            <tr class="text-default-800">
                                                ...
                                                <td class="px-3.5 py-2.5 whitespace-nowrap">
                                                    <span class="py-0.5 px-2.5 inline-flex items-center gap-x-1 text-xs font-medium bg-success/15 text-success rounded">
                                            ...
                                            <tr class="text-default-800">
                                                ...
                                                <td class="px-3.5 py-2.5 whitespace-nowrap">
                                                    <span class="py-0.5 px-2.5 inline-flex items-center gap-x-1 text-xs font-medium bg-danger/15 text-danger rounded">
                                                        <i data-lucide="x-circle" class="size-3"></i> Unactive
                                                    </span>
                                                </td>
                                            </tr>
                ...
                <div class="grid lg:grid-cols-4 grid-cols-1 gap-5">
                            ...
                            <ul class="flex flex-col gap-5">
                                <li class="flex items-center gap-3 text-sm">
                                    <div class="bg-danger/10 btn size-8">
                                        <i data-lucide="mail" class="text-danger size-4"></i>
                                    </div>
                                ...
                                <li class="flex items-center gap-3 text-sm">
                                    <div class="bg-secondary/10 btn size-8">
                                        <i data-lucide="users" class="text-secondary size-4"></i>
                                    </div>
                                ...
                                <li class="flex items-center gap-3 text-sm">
                                    <div class="bg-orange-500/10 btn size-8">
                                        <i data-lucide="user-x-2" class="text-orange-500 size-4"></i>
                                    </div>
                                ...
                                <li class="flex items-center gap-3 text-sm">
                                    <div class="bg-success/10 btn size-8">
                                        <i data-lucide="eye" class="text-success size-4"></i>
                                    </div>
                                ...
                                <li class="flex items-center gap-3 text-sm">
                                    <div class="bg-info/10 btn size-8">
                                        <i data-lucide="user-x-2" class="text-info size-4"></i>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="#" class="text-primary underline">See More</a>
                        </div>
    ...
    <script src="/src/scripts/pages/dashboard-analytics.js" type="module"></script>
