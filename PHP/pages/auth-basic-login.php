        ...
        <div class="card md:w-lg w-screen z-10">
            <div class="text-center px-10 py-12">
                ...
                <form action="/" class="text-left w-full mt-10">
                    ...
                    <div class="mb-4">
                        <a href="/auth-basic-reset-password" class="text-primary font-medium text-sm mb-2 float-end">Forgot Password ?</a>
                    ...
                    <div class="mt-10 text-center">
                        <p class="text-base text-default-500">Don't have an Account ?
                            <a href="/auth-basic-register" class="font-semibold underline hover:text-primary transition duration-200">SignUp</a>
                        </p>
                    </div>
                </form>
            </div>
