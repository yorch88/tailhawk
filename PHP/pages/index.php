...
<body>
                        ...
                        <div class="card-body relative overflow-hidden bg-zinc-900 rounded-md mb-5">
                            <div class="relative z-10 grid grid-cols-12 items-center">
                                ...
                                <div class="col-span-4 ms-auto lg:block hidden">
                                    <img src="%BASE%/images/dashboard.png" alt="" class="h-40">
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="flex items-center justify-center mx-auto rounded-full size-14 bg-info/10">
                                        <i data-lucide="package" class="size-6 text-info"></i>
                                    </div>
                                    <h5 class="mt-4 text-center mb-2 text-default-800 font-semibold text-lg">
                                    ...
                                    <div class="col-span-1">
                                        <div class="flex items-center gap-3">
                                            <div class="btn size-12 bg-secondary/10">
                                                <i data-lucide="bar-chart" class="text-secondary size-6"></i>
                                            </div>
                            ...
                            <div>
                                ...
                                <div class="divide-y divide-default-200">
                                    <div class="flex items-center justify-between text-sm">
                                        <div class="flex items-center gap-3 py-2.25">
                                            <div class="size-8 rounded-full bg-default-100">
                                                <img src="%BASE%/images/user/avatar-2.png" alt="" class="size-8 rounded-full">
                                            </div>
                                            <div>
                                    ...
                                    <div class="flex items-center justify-between text-sm">
                                        <div class="flex items-center gap-3 py-2.25">
                                            <div class="size-8 rounded-full bg-default-100">
                                                <img src="%BASE%/images/user/avatar-3.png" alt="" class="size-8 rounded-full">
                                            </div>
                                            <div>
                                    ...
                                    <div class="flex items-center justify-between text-sm">
                                        <div class="flex items-center gap-3 py-2.25">
                                            <div class="size-8 rounded-full bg-default-100">
                                                <img src="%BASE%/images/user/avatar-4.png" alt="" class="size-8 rounded-full">
                                            </div>
                                            <div>
                                    ...
                                    <div class="flex items-center justify-between text-sm">
                                        <div class="flex items-center gap-3 pt-2">
                                            <div class="size-8 rounded-full bg-default-100">
                                                <img src="%BASE%/images/user/avatar-5.png" alt="" class="size-8 rounded-full">
                                            </div>
                                            <div>
                        ...
                        <div class="card-body">
                            <div class="flex flex-col gap-5">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3 whitespace-nowrap">
                                        <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                            <img src="%BASE%/images/product/img-02.png" alt="" class="h-6">
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex items-center text-yellow-500 gap-0.5">
                                                ...
                                                <i data-lucide="star" class="fill-yellow-500 size-3.5"></i>
                                                <i data-lucide="star" class="fill-yellow-500 size-3.5"></i>
                                                <i data-lucide="star-half" class="fill-yellow-500 size-3.5"></i>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                            <img src="%BASE%/images/product/img-03.png" alt="" class="h-6">
                                        </div>
                                        <div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                            <img src="%BASE%/images/product/img-04.png" alt="" class="h-6">
                                        </div>
                                        <div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                            <img src="%BASE%/images/product/img-05.png" alt="" class="h-6">
                                        </div>
                                        <div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                            <img src="%BASE%/images/product/img-06.png" alt="" class="h-6">
                                        </div>
                                        <div>
    ...
    <script src="/src/scripts/pages/dashboard-ecommerce.js" type="module"></script>
