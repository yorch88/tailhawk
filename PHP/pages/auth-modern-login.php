                        ...
                        <div class="mt-10 w-100 mx-auto">
                            ...
                            <div id="tabsForEmail" role="tabpanel" aria-labelledby="tabs-with-underline-item-1">
                                <form action="/" class="text-left w-full mt-10">
                                    ...
                                    <div class="mb-4">
                                        <a href="/auth-modern-reset-password" class="text-primary font-medium text-sm mb-2 float-end">Forgot Password ?</a>
                                    ...
                                    <div class="mt-10 text-center">
                                        <p class="text-base text-default-500">Don't have an account ?
                                            <a href="/auth-modern-register" class="font-semibold underline hover:text-primary transition duration-200"> SignUp</a>
                                        </p>
                                    </div>
                                </form>
                            </div>
