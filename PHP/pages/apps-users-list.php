                                    ...
                                    <table class="min-w-full divide-y divide-default-200">
                                        ...
                                        <tbody>
                                                ...
                                                <td class="flex py-3 px-3.5 items-center gap-3">
                                                    ...
                                                    <div>
                                                        <h6 class="mb-1.5 font-semibold">
                                                            <a href="#" class="text-default-800">Marie Prohaska</a>
                                                        </h6>
                                            ...
                                            <tr class="text-default-800 font-normal text-sm whitespace-nowrap">
                                                ...
                                                <td class="flex py-3 px-3.5 items-center gap-3">
                                                    <div class="size-10 rounded-full bg-default-200">
                                                        <img src="/images/user/avatar-1.png" alt="" class="h-10 rounded-full" />
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-1.5 font-semibold"><a href="#" class="text-default-800">Jaqueline Hammes</a></h6>
                                                ...
                                                <td class="px-3.5 py-3 whitespace-nowrap">
                                                    <span class="py-0.5 px-2.5 inline-flex items-center gap-x-1 text-xs font-medium bg-default-200 text-default-600 rounded">
                                                        <i data-lucide="loader" class="size-3"></i> Waiting
                                                    </span>
                                                </td>
                                                <td class="px-3.5 py-3">
                                                    <div class="hs-dropdown relative inline-flex">
                                            ...
                                            <tr class="text-default-800 font-normal text-sm whitespace-nowrap">
                                                ...
                                                <td class="flex py-3 px-3.5 items-center gap-3">
                                                    <div class="size-10 rounded-full bg-default-200"><img src="/images/user/avatar-2.png" alt="" class="h-10 rounded-full" /></div>
                                                    <div>
                                                        <h6 class="mb-1.5 font-semibold"><a href="#" class="text-default-800">Marlene Hirthe</a></h6>
                                            ...
                                            <tr class="text-default-800 font-normal text-sm whitespace-nowrap">
                                                ...
                                                <td class="flex py-3 px-3.5 items-center gap-3">
                                                    <div class="size-10 rounded-full bg-default-200"><img src="/images/user/avatar-3.png" alt="" class="h-10 rounded-full" /></div>
                                                    <div>
                                                        <h6 class="mb-1.5 font-semibold"><a href="#" class="text-default-800">Akeem Paucek</a></h6>
                                                ...
                                                <td class="px-3.5 py-3 whitespace-nowrap"><span class="py-0.5 px-2.5 inline-flex items-center gap-x-1 text-xs font-medium bg-danger/10 text-danger rounded"><i data-lucide="x-circle" class="size-3"></i> Rejected</span></td>
                                                <td class="px-3.5 py-3">
                                                    <div class="hs-dropdown relative inline-flex">
                                                        <button type="button" class="hs-dropdown-toggle btn size-7.5 bg-default-200 hover:bg-default-600 text-default-500" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown" hs-dropdown-placement="bottom-end">
                                                            <i class="iconify lucide--ellipsis size-4"></i>
                                            ...
                                            <tr class="text-default-800 font-normal text-sm whitespace-nowrap">
                                                ...
                                                <td class="px-4 py-3 flex items-center gap-3">
                                                    <img src="/images/user/avatar-1.png" class="w-9 h-9 rounded-full" alt="">
                                                    <div class="text-sm">
                                                ...
                                                <td class="px-4 py-3">
                                                    <span class="py-0.5 px-2.5 inline-flex items-center gap-x-1 text-xs font-medium bg-danger/10 text-danger rounded"><i data-lucide="x-circle" class="size-3"></i> Rejected</span>
                                                </td>
                                                <td class="px-4 py-3">
                                            ...
                                            <tr class="text-default-800 font-normal text-sm whitespace-nowrap">
                                                ...
                                                <td class="px-4 py-3 flex items-center gap-3">
                                                    <div class="w-9 h-9 flex items-center justify-center rounded-full bg-default-200 font-semibold">DT</div>
                                                    <div class="text-sm">
                                            ...
                                            <tr class="text-default-800 font-normal text-sm whitespace-nowrap">
                                                ...
                                                <td class="px-4 py-3 flex items-center gap-3">
                                                    <img src="/images/user/avatar-2.png" class="w-9 h-9 rounded-full" alt="">
                                                    <div class="text-sm">
                                            ...
                                            <tr class="text-default-800 font-normal text-sm whitespace-nowrap">
                                                ...
                                                <td class="px-4 py-3 flex items-center gap-3">
                                                    <img src="/images/user/avatar-3.png" class="w-9 h-9 rounded-full" alt="">
                                                    <div class="text-sm">
                                            ...
                                            <tr class="text-default-800 font-normal text-sm whitespace-nowrap">
                                                ...
                                                <td class="px-4 py-3 flex items-center gap-3">
                                                    <div class="w-9 h-9 flex items-center justify-center rounded-full bg-default-200 font-semibold">RL</div>
                                                    <div class="text-sm">
                                            ...
                                            <tr class="text-default-800 font-normal text-sm whitespace-nowrap">
                                                ...
                                                <td class="px-4 py-3 flex items-center gap-3">
                                                    <img src="/images/user/avatar-4.png" class="w-9 h-9 rounded-full" alt="">
                                                    <div class="text-sm">
