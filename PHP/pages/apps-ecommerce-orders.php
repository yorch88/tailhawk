...
<body>
                        ...
                        <div class="grid md:grid-cols-2 grid-cols-1 gap-5">
                                ...
                                <div class="card-body">
                                    <div class="flex items-center gap-3">
                                        <div class="btn size-12 text-15 bg-primary/10 text-primary">
                                            <i data-lucide="boxes" class="size-6"></i>
                                        </div>

                                        <div>
                                            <h5 class="mb-1 text-base font-semibold text-default-800" data-target="15101">15,101</h5>
                                ...
                                <div class="card-body">
                                    <div class="flex items-center gap-3">
                                        <div class="btn size-12 text-15 bg-warning/15 text-warning">
                                            <i data-lucide="loader" class="size-6"></i>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="flex items-center gap-3">
                                        <div class="btn size-12 text-15 bg-primary/10 text-primary">
                                            <i data-lucide="package-plus" class="size-6"></i>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="flex items-center gap-3">
                                        <div class="btn size-12 text-15 bg-success/10 text-success">
                                            <i data-lucide="package-check" class="size-6"></i>
                                        </div>

                                        <div>
                                            <h5 class="mb-1 text-base font-semibold text-default-800" data-target="30,914">30,914</h5>
                                ...
                                <div class="card-body">
                                    <div class="flex items-center gap-3">
                                        <div class="btn size-12 text-15 bg-danger/10 text-danger">
                                            <i data-lucide="package-x" class="size-6"></i>
                                        </div>
                    ...
                    <div class="card-header">
                        <div class="flex items-center flex-wrap gap-3">
                            <button type="button" class="btn btn-sm bg-primary  text-white font-medium">
                                <i data-lucide="boxes" class="size-4"></i>
                                All Orders
                            </button>
                            ...
                            <button type="button" class="btn btn-sm text-default-500 hover:text-primary border-0 bg-transparent">
                                <i data-lucide="package-check" class="size-4"></i>
                                Delivered
                            </button>
                            ...
                            <button type="button" class="btn btn-sm text-default-500 hover:text-primary border-0 bg-transparent">
                                <i data-lucide="package-x" class="size-4"></i>
                                Cancelled
                            </button>
                        </div>
                    </div>
                                    ...
                                    <table class="min-w-full  divide-y divide-default-200">
                                        ...
                                        <tbody class="divide-y divide-default-200">
                                            ...
                                            <tr class="text-default-800 font-normal">
                                                ...
                                                <td class="px-3.5 py-2.5 whitespace-nowrap">
                                                    <span class="inline-flex items-center gap-x-1.5 py-0.5 px-2.5 rounded text-xs font-medium bg-secondary/10 text-secondary border border-secondary/30">Shipping</span>
                                                </td>
                                                <td class="px-3.5 py-2.5">
                                                    <div class="hs-dropdown relative inline-flex">
                                                        <button type="button" class="hs-dropdown-toggle btn size-7.5 bg-default-200 hover:bg-default-600 text-default-500 hover:text-white" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown" hs-dropdown-placement="bottom-end">
                                            ...
                                            <tr class="text-default-800 font-normal">
                                                ...
                                                <td class="px-3.5 py-2.5 whitespace-nowrap">
                                                    <span class="inline-flex items-center gap-x-1.5 py-0.5 px-2.5 rounded text-xs font-medium    bg-info/10 text-info border border-info/30">New</span>
                                                </td>
                                                <td class="px-3.5 py-2.5">
                                                    <div class="hs-dropdown relative inline-flex">
                                                        <button type="button" class="hs-dropdown-toggle btn size-7.5 bg-default-200 hover:bg-default-600 text-default-500 hover:text-white" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown" hs-dropdown-placement="bottom-end">
                                            ...
                                            <tr class="text-default-800 font-normal">
                                                ...
                                                <td class="px-3.5 py-2.5 whitespace-nowrap">
                                                    <span class="inline-flex items-center gap-x-1.5 py-0.5 px-2.5 rounded text-xs font-normal bg-default-100 text-default-800/80 border border-default-800/20">Return</span>
                                                </td>
                                                <td class="px-3.5 py-2.5">
                                                    <div class="hs-dropdown relative inline-flex">
                                                        <button type="button" class="hs-dropdown-toggle btn size-7.5 bg-default-200 hover:bg-default-600 text-default-500 hover:text-white" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown" hs-dropdown-placement="bottom-end">
                                            ...
                                            <tr class="text-default-800 font-normal">
                                                ...
                                                <td class="px-3.5 py-2.5 whitespace-nowrap">
                                                    <span class="inline-flex items-center gap-x-1.5 py-0.5 px-2.5 rounded text-xs font-medium bg-danger/10 text-danger border border-danger/30">Cancelled</span>
                                                </td>
                                                <td class="px-3.5 py-2.5">
                                                    <div class="hs-dropdown relative inline-flex">
                                                        <button type="button" class="hs-dropdown-toggle btn size-7.5 bg-default-200 hover:bg-default-600 text-default-500 hover:text-white" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown" hs-dropdown-placement="bottom-end">
    ...
    <script src="/src/scripts/pages/apps-ecommerce-orders.js" type="module"></script>
