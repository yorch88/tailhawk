                ...
                <div class="my-auto">
                    ...
                    <form action="/">
                        ...
                        <div class="mt-4 text-center">
                            <p class="text-base text-default-800">Hold on, I've got my password... <a href="/auth-modern-login" class="text-primary underline"> Click here </a></p>
                        </div>
                    </form>
                </div>
