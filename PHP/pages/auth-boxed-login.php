                    ...
                    <div class="lg:col-span-5">
                        <div class="text-center px-10 py-12">
                            ...
                            <form action="/" class="text-left w-full mt-10">
                                ...
                                <div class="mb-4">
                                    <a href="/auth-boxed-reset-password" class="text-primary font-medium text-sm mb-2 float-end">Forgot Password ?</a>
                                ...
                                <div class="mt-10 text-center">
                                    <p class="text-base text-default-500">Don't have an account ?
                                        <a href="/auth-boxed-register" class="font-semibold underline hover:text-primary transition duration-200"> SignUp</a>
                                    </p>
                                </div>
                            </form>
                        </div>
