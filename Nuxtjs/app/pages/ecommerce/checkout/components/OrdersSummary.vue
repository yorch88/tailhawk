<template>
  <div class="col-span-1">
    <div class="p-5 card mb-5">
      ...
      <div class="px-4 py-3 mb-4 text-danger rounded-md bg-red-50">These products are limited, checkout within <span class="font-bold">03m 21s</span></div>
      <div class="">
        <div class="flex justify-between items-center gap-5 py-4 border-b border-dashed border-default-200">
          <div class="flex items-center gap-3">
            <div class="flex items-center justify-center rounded-md size-12 bg-default-100">
              <img :src="img08" alt="" class="h-8" />
            </div>
            <div class="">
              <h6 class="mb-1 text-[15px] text-default-800 font-semibold"><a href="/ecommerce/product-grid" class="transition-all duration-300 ease-linear hover:text-primary">Roar Twill Blue Baseball Cap</a></h6>
        ...
        <div class="flex justify-between items-center gap-5 py-4 border-b border-dashed border-default-200">
          <div class="flex items-center gap-3">
            <div class="flex items-center justify-center rounded-md size-12 bg-default-100">
              <img :src="img04" alt="" class="h-8" />
            </div>
            <div class="">
              <h6 class="mb-1 text-[15px] text-default-800 font-semibold"><a href="/ecommerce/product-grid" class="transition-all duration-300 ease-linear hover:text-primary">Mesh Ergonomic Green Chair</a></h6>
        ...
        <div class="flex justify-between items-center gap-5 py-4 border-b border-dashed border-default-200">
          <div class="flex items-center gap-3">
            <div class="flex items-center justify-center rounded-md size-12 bg-default-100">
              <img :src="img01" alt="" class="h-8" />
            </div>
            <div class="">
              <h6 class="mb-1 text-[15px] text-default-800 font-semibold"><a href="/ecommerce/product-grid" class="transition-all duration-300 ease-linear hover:text-primary">Smartest Printed T-shirt</a></h6>
      ...
      <div class="mt-4">
        <button type="button" class="text-[13px] py-2 px-4 rounded bg-primary text-white transition-all duration-300 hover:bg-blue-600 inline-flex justify-center w-full items-center">
          Place Order
          <Icon icon="lucide:move-right" class="size-4 ms-1.5"></Icon>
        </button>
      </div>
    </div>
    <div class="mb-5">
