<template>
  <Vertical>
    <PageTitle subtitle="Menu" title="Create Payslip" />
        ...
        <div class="card-body">
          ...
          <div class="mt-16 lg:max-w-md w-full">
            ...
            <div class="mb-4">
              ...
              <input ref="fromRef" type="text" id="createDateInput" class="form-input" placeholder="Select date" data-provider="flatpickr" data-date-format="d M, Y" readonly />
            </div>
          </div>
              ...
              <tbody>
                <tr>
                  <td class="px-3.5 py-2.5">
                    <input ref="toRef" type="text" class="form-input" placeholder="Select date" data-provider="flatpickr" data-date-format="d M, Y" readonly />
                  </td>
                ...
                <tr>
                  <td colspan="6">
                    <button type="button" class="btn bg-transparent border border-dashed border-primary text-primary hover:bg-primary/10">
                      <Icon icon="lucide:plus" class="size-3 me-1"></Icon>
                      Add Item
                    </button>
                  </td>
                </tr>
