          ...
          <div class="lg:col-span-5">
            <div class="text-center px-10 py-12">
              <div class="mt-8">
                ...
                <p class="text-base mb-8 text-default-500">Did you not receive an email? Please <a href="#" class="text-primary"> try again</a></p>
                <button type="button" class="btn bg-primary text-white w-full">Skip Now</button>
                <div class="pt-10 text-center">
                  <img :src="email" alt="" class="block w-2/3 mx-auto" />
                </div>
              </div>
            </div>
          </div>
