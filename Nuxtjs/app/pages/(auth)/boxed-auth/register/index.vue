                  ...
                  <form action="/" class="text-left w-full mt-10">
                    ...
                    <div class="mt-10 text-center">
                      <p class="text-base text-default-500">
                        ...
                        <a href="/boxed-auth/login" class="font-semibold underline hover:text-primary transition duration-200">Login</a>
                      </p>
                    </div>
                  </form>
                </div>
                <div id="tabsForPhone" class="hidden" role="tabpanel" aria-labelledby="tabs-with-underline-item-2">
                  <form action="/" class="text-left w-full mt-10">
                    ...
                    <div class="mt-10 text-center">
                      <p class="text-base text-default-500">
                        Already have an account ?
                        <a href="/basic-auth/login" class="font-semibold underline hover:text-primary transition duration-200">Login</a>
                      </p>
                    </div>
                  </form>
                </div>
