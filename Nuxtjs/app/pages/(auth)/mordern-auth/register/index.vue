      ...
      <div class="flex flex-col h-full w-full">
            ...
            <div class="mt-10 w-100 mx-auto">
              <div id="tabsForEmail" role="tabpanel" aria-labelledby="tabs-with-underline-item-1">
                <form action="/" class="text-left w-full mt-10">
                  <div class="mb-4">
                    <label for="Username" class="block font-medium text-default-900 text-sm mb-2">Email ID</label>
                    <input type="email" id="Username" class="form-input" placeholder="Enter Username or email" />
                  </div>
                  <div class="mb-4">
                  ...
                  <div class="mt-10 text-center">
                    <button type="button" class="btn bg-primary text-white w-full">Sign Up</button>
                  </div>
                  <div class="my-9 relative text-center before:absolute before:top-2.5 before:left-0 before:border-t before:border-t-default-200 before:w-full before:h-0.5 before:right-0 before:-z-0">
                    <h4 class="relative z-1 py-0.5 px-2 inline-block font-medium bg-card text-default-500 rounded-md">Already have an account ?</h4>
                  </div>
                  ...
                  <div class="mt-10 text-center">
                    <p class="text-base text-default-500">
                      ...
                      <a href="/modern-auth/login" class="font-semibold underline hover:text-primary transition duration-200">Login</a>
                    </p>
                  </div>
                </form>
              </div>
        ...
        <div class="mt-5">
          <span class="text-sm text-default-500">
            ...
            by
            <a href="https://themesdesign.in/" target="_blank" class="text-default-800 hover:text-primary transition duration-200 underline">Themesdesign</a>
          </span>
        </div>
      </div>
    </div>
