<template>
  <Auth>
    ...
    <div class="p-3 mb-6 text-sm rounded-md font-normal text-warning bg-warning/15">Provide your email address, and instructions will be sent to you</div>
    <form action="/">
      ...
      <div class="mt-4 text-center">
        <p class="text-base text-default-800">Wait, I remember my password... <a href="/basic-auth/login" class="text-primary underline"> Click here </a></p>
      </div>
    </form>
  </Auth>
</template>
