<template>
  <Vertical>
    <PageTitle subtitle="Menu" title="Overview" />
    <div class="card">
      <div class="card-body">
        <div class="pb-5">
          <div class="flex flex-wrap justify-between md:gap-0 gap-4 items-center">
            <div>
              <h6 class="mb-1 card-title">#TW15090257</h6>
            ...
            <div class="flex gap-2">
              <button class="bg-purple-600 text-white btn hover:bg-purple-700">Download</button>
              <button class="bg-primary text-nowrap text-white btn hover:bg-blue-600" onclick="window.print()"><Icon icon="lucide:save" class="size-4 text-white"></Icon>Save & Draft</button>
              <div class="hs-dropdown relative inline-flex">
                <button type="button" class="hs-dropdown-toggle btn size-9.5 bg-default-200 hover:bg-default-600 text-default-500 hover:text-white" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown" hs-dropdown-placement="bottom-end">
                  <Icon icon="lucide:ellipsis" class="iconify size-4"></Icon>
                </button>
                <div class="hs-dropdown-menu" role="menu">
                  <RouterLink class="flex items-center gap-1.5 py-1.5 font-medium px-3 text-sm text-default-500 hover:bg-default-150 rounded" to="">
        ...
        <div class="border rounded border-default-200">
          <div class="p-8">
            <div class="grid lg:grid-cols-12 items-center gap-4">
              <div class="lg:col-span-3 text-start">
                <div class="size-16 bg-default-100 flex items-center justify-center rounded-md">
                  <img :src="sm" alt="" class="h-8" />
                </div>
                <h5 class="mt-4 mb-1 card-title">Themesdesign</h5>
              ...
              <div class="lg:col-span-9 lg:col-start-12 lg:text-end text-start text-sm">
                ...
                <p class="mb-1 text-default-500">Website: <RouterLink to="https://themesdesign.in" target="_blank" class="font-semibold underline text-primary">www.themesdesign.in</RouterLink></p>
                <p class="text-default-500">Contact No: <span class="font-semibold">+(01) 123 678 9654</span></p>
              </div>
            </div>
            <div class="grid md:grid-cols-4 grid-cols-1 mt-6 text-center md:divide-x divide-default-200 divide-dashed">
              ...
              <div class="p-3 test-sm">
                <span class="inline-flex items-center gap-x-1.5 py-0.5 px-2.5 rounded text-xs font-medium bg-success/10 text-success border border-success/20">Paid</span>
              ...
              <table class="w-full whitespace-nowrap">
                ...
                <tbody>
                  <tr class="text-default-500 text-sm">
                    <td colspan="3"></td>
                    <td class="border-b border-default-200 px-3.5 py-2.5">Sub Total</td>
                    <td class="border-b border-default-200 px-3.5 py-2.5">$292</td>
                  </tr>
                  <tr class="text-default-500 text-sm">
                    <td colspan="3"></td>
                    <td class="border-b border-default-200 px-3.5 py-2.5">Estimated Tax (18%)</td>
                    <td class="border-b border-default-200 px-3.5 py-2.5">$52.56</td>
                  </tr>
                  <tr class="text-default-500 text-sm">
                    <td colspan="3"></td>
                    <td class="border-b border-default-200 px-3.5 py-2.5">Item Discounts (15%)</td>
                    <td class="border-b border-default-200 px-3.5 py-2.5">-$43.8</td>
                  </tr>
                  <tr class="text-default-500 text-sm">
                    <td colspan="3"></td>
                    <td class="border-b border-default-200 px-3.5 py-2.5">Shipping Charge</td>
                    <td class="border-b border-default-200 px-3.5 py-2.5">$29</td>
                  </tr>
                  <tr>
                    <td colspan="3"></td>
                    <td class="border-b border-default-200 px-3.5 py-2.5 font-medium text-sm">Total Amount</td>
                    <td class="border-b border-default-200 px-3.5 py-2.5 font-medium text-sm">$329.76</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <p class="px-4 py-3 text-sm font-medium rounded-lg border border-info/20 text-info bg-info/10"><b>NOTES:</b> All accounts are to be paid within 7 days from receipt of invoice. To be paid by cheque or credit card or direct payment online. If account is not paid within 7 days the credits details supplied as confirmation of work undertaken will be charged the agreed quoted fee noted above.</p>
          </div>
        </div>
      </div>
    </div>
