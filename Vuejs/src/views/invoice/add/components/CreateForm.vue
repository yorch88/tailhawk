    ...
    <div class="card-body">
      ...
      <div class="grid lg:grid-cols-4 grid-cols-1 gap-5 mb-6">
        <div class="col-span-1">
          <label for="First Name" class="inline-block mb-2 text-sm text-default-800 font-medium">Invoice No. </label>
          <input type="text" id="First Name" class="form-input" placeholder="Enter invoice no.." value="#TW15090251" readonly />
        </div>

        <div class="col-span-1">
          <label for="invoiceNo" class="inline-block mb-2 text-sm text-default-800 font-medium">Invoice Date</label>
          <input ref="inputRef" type="date" id="invoiceNo" class="form-input" placeholder="Invoice Date" data-provider="flatpickr" data-date-format="d M, Y" required />
        </div>

        <div class="col-span-1">
          <label for="InvoiceDue" class="inline-block mb-2 text-sm text-default-800 font-medium">Invoice Due</label>
        ...
        <div class="col-span-1">
          <label for="emailInvoiceInput" class="inline-block mb-2 text-sm text-default-800 font-medium">Email </label>
        ...
        <div class="col-span-1">
          <label for="contactInput" class="inline-block mb-2 text-default-800 text-sm font-medium">Contact US</label>
          <input type="number" id="contactInput" class="form-input" placeholder="(241) 1234 567 8900" required />
        </div>

        <div class="col-span-1">
          <label for="paymentStatus" class="inline-block mb-2 text-sm text-default-800 font-medium">Payment Status</label>
      ...
      <div class="grid lg:grid-cols-4 grid-cols-1 gap-5">
        ...
        <div class="col-span-1">
          <label for="taxShippingInput" class="inline-block mb-2 text-sm text-default-800 font-medium">TAX No.</label>
      ...
      <div class="grid lg:grid-cols-4 grid-cols-1 gap-5">
        ...
        <div class="col-span-1">
          <label for="taxBillingInput" class="inline-block mb-2 text-sm text-default-800 font-medium">TAX No.</label>
        ...
        <table class="w-full whitespace-nowrap">
          ...
          <tbody class="item-list">
            <tr class="border border-default-200">
              <td class="">
                <input type="text" id="itemName1" class="bg-transparent block w-full border-0 rounded-md text-sm text-default-500 placeholder:text-default-400 ring-0" placeholder="Item Name" required style="background-color: transparent; border: 0" />
              </td>
              <td class="w-40 border rounded-xl border-default-200">
                <div class="flex p-2 justify-center">
                  <button type="button" class="size-9 minusBtn border rounded-tr-0 rounded-br-0 border-default-200 flex justify-center items-center">
                    <Icon icon="lucide:minus" class="size-4 text-default-500"></Icon>
                  </button>
                  <input type="number" class="text-center ps-2 w-12 h-9 border-t border-b border-e-0 bg-transparent border-l-0 border-default-200 ring-0 product-quantity focus:shadow-none" value="2" min="0" max="100" readonly style="background-color: transparent; border: 0" />
                  <button type="button" class="size-9 plusBtn rounded-tl-0 rounded-bl-0 border border-default-200 flex justify-center items-center">
                    <Icon icon="lucide:plus" class="size-4 text-default-500"></Icon>
                  </button>
                </div>
              </td>
              <td class="w-40 border border-default-200">
                <input type="text" id="itemName1" class="bg-transparent block w-full border-0 rounded-md text-sm text-default-500 placeholder:text-default-400 ring-0" placeholder="$00.00" required style="background-color: transparent; border: 0" />
              </td>
              <td class="w-40 border border-default-200">
                <input type="text" id="itemName1" class="bg-transparent block w-full border-0 rounded-md text-sm text-default-500 placeholder:text-default-400 ring-0" placeholder="0%" required style="background-color: transparent; border: 0" />
              </td>
              <td class="w-40 border border-default-200">
                <input type="text" id="itemName1" class="bg-transparent block w-full border-0 rounded-md text-sm text-default-500 placeholder:text-default-400 ring-0" placeholder="0%" required style="background-color: transparent; border: 0" />
              </td>
              <td class="border border-default-200" rowspan="2">
                <div class="mb-1">
                  <input type="text" id="ItemTotal" class="bg-transparent block w-full border-0 rounded-md text-sm text-default-500 placeholder:text-default-400 ring-0" placeholder="$00.00" required readonly style="background-color: transparent; border: 0" />
                </div>
                <input type="text" id="itemDiscountsInput" class="bg-transparent block w-full border-0 rounded-md text-sm text-default-500 placeholder:text-default-400 ring-0" placeholder="-$00.00" required readonly style="background-color: transparent; border: 0" />
              </td>
            </tr>
            <tr>
              <td class="border border-default-200">
                <input type="text" id="itemdescription1" class="bg-transparent block w-full border-0 rounded-md text-sm text-default-500 placeholder:text-default-400 ring-0" placeholder="Enter Description (Optional)" required style="background-color: transparent; border: 0" />
              </td>
            ...
            <tr class="item">
              ...
              <td class="w-40 border rounded-xl border-default-200">
                <div class="flex p-2 justify-center">
                  ...
                  <input type="number" class="text-center ps-2 w-12 h-9 border-t bg-transparent border-b border-e-0 border-l-0 border-default-200 ring-0 product-quantity focus:shadow-none" value="2" min="0" max="100" readonly style="background-color: transparent; border: 0" />
                  <button type="button" class="size-9 plusBtn rounded-tl-0 rounded-bl-0 border border-default-200 flex justify-center items-center">
                    <Icon icon="lucide:plus" class="size-4 text-default-500"></Icon>
                  </button>
                </div>
              ...
              <td class="w-40 border border-default-200">
                <input type="number" id="itemName1" class="bg-transparent block w-full border-0 rounded-md text-sm text-default-500 placeholder:text-default-400 ring-0" placeholder="$00.00" required style="background-color: transparent; border: 0" />
              </td>
              <td class="w-40 border border-default-200">
                <input type="text" id="itemName1" class="bg-transparent block w-full border-0 rounded-md text-sm text-default-500 placeholder:text-default-400 ring-0" placeholder="0%" required style="background-color: transparent; border: 0" />
              </td>
              ...
              <td class="border border-default-200" rowspan="2">
                <div class="mb-1">
                  <input type="text" id="ItemTotal" class="bg-transparent block w-full border-0 rounded-md text-sm text-default-500 placeholder:text-default-400 ring-0" placeholder="$00.00" readonly style="background-color: transparent; border: 0" />
                </div>
                <input type="text" id="itemDiscountsInput" class="bg-transparent block w-full border-0 rounded-md text-sm text-default-500 placeholder:text-default-400 ring-0" placeholder="-$00.00" readonly style="background-color: transparent; border: 0" />
              </td>
            </tr>
            <tr>
              <td class="border border-default-200">
          ...
          <tbody class="before:block before:h-3" id="totalAmount">
            <tr class="text-default-800">
              <td colspan="4"></td>
              <td class="border-b border-default-200 text-default-500 text-sm">Sub Total</td>
              <td class="font-medium border-b border-default-200">
                <input type="text" id="subTotale" class="bg-transparent block w-full border-0 rounded-md text-sm text-default-800 placeholder:text-default-800 ring-0" placeholder="$00.00" readonly style="background-color: transparent; border: 0" />
              </td>
            </tr>
            <tr class="text-default-800">
              <td colspan="4"></td>
              <td class="border-b border-default-200 text-default-600 text-sm">Estimated Tax (18%)</td>
            ...
            <tr class="text-default-800">
              <td colspan="4"></td>
              <td class="border-b border-default-200 text-default-600 text-sm">Item Discounts</td>
              <td class="font-medium border-b border-default-200">
                <input type="text" id="subTotale" class="bg-transparent block w-full border-0 rounded-md text-sm text-default-800 placeholder:text-default-800 ring-0" placeholder="$00.00" readonly style="background-color: transparent; border: 0" />
              </td>
            </tr>
            <tr class="text-default-800">
              <td colspan="4"></td>
              <td class="border-b border-default-200 text-default-600 text-sm">Shipping Charge</td>
              <td class="font-medium border-b border-default-200">
                <input type="text" id="subTotale" class="bg-transparent block w-full border-0 rounded-md text-sm text-default-800 placeholder:text-default-800 ring-0" placeholder="$00.00" readonly style="background-color: transparent; border: 0" />
              </td>
            </tr>
            <tr class="text-default-800">
              <td colspan="4"></td>
              <td class="border-b border-default-200 text-default-600 text-sm">Total Amount</td>
              <td class="font-medium border-b border-default-200">
                <input type="text" id="subTotale" class="bg-transparent block w-full border-0 rounded-md text-sm text-default-800 placeholder:text-default-800 ring-0" placeholder="$00.00" readonly style="background-color: transparent; border: 0" />
              </td>
            </tr>
      ...
      <div class="grid lg:grid-cols-4 grid-cols-1 gap-5">
        ...
        <div class="col-span-1">
          <label for="cardHolderName" class="inline-block mb-2 text-sm text-default-800 font-medium">Card Holder Name</label>
        ...
        <div class="col-span-1">
          <label for="cardNumber" class="inline-block mb-2 text-sm text-default-800 font-medium">Card Number</label>
          <input type="text" id="cardNumber" class="form-input" placeholder="xxxx xxxx xxxx xxxx" required />
        </div>
        <div class="col-span-1">
          <label for="totalPayment" class="inline-block mb-2 text-sm text-default-800 font-medium">Total Payment</label>
      ...
      <div class="flex justify-end items-center mt-5">
        <div class="flex flex-wrap items-center gap-2">
          <button class="bg-default-200 text-default-500 text-nowrap border-0 btn hover:bg-default-300"><Icon icon="lucide:refresh-ccw" class="size-4 me-1"></Icon>Reset</button>
          <button class="text-white border-0 btn text-nowrap bg-primary"><Icon icon="lucide:save" class="size-4 me-1"></Icon>Save</button>
          <button class="bg-teal-600 border-0 text-nowrap text-white btn hover:bg-tral-700"><Icon icon="lucide:download" class="size-4 me-1"></Icon>Download</button>
        </div>
      </div>
    </div>
  </div>
