    ...
    <div class="card">
      <div class="card-body">
        <div class="flex flex-wrap justify-between items-center md:gap-0 gap-4">
          ...
          <div class="flex gap-2">
            <button class="btn bg-primary text-white" onclick="window.print()"><Icon icon="lucide:save" class="size-4 text-white me-1"></Icon> Save & Draft</button>
      ...
      <div>
        <div class="card-body">
          ...
          <p class="px-4 py-3 text-sm rounded-lg border border-info/20 text-info bg-info/10"><b>NOTES:</b> All accounts are to be paid within 7 days from receipt of invoice. To be paid by cheque or credit card or direct payment online. If account is not paid within 7 days the credits details supplied as confirmation of work undertaken will be charged the agreed quoted fee noted above.</p>
        </div>
      </div>
    </div>
  </div>
