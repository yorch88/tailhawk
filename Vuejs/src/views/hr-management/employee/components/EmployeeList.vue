              ...
              <tr class="text-default-800 font-normal whitespace-nowrap" v-for="(item, idx) in employees" :key="idx">
                ...
                <td class="px-3.5 py-3">
                  <div class="flex items-center gap-2">
                    <RouterLink to="" class="flex size-8 bg-default-200 rounded-md items-center justify-center hover:bg-primary/10 hover:text-primary transition-all text-default-600">
                      <Icon icon="lucide:eye" class="size-3"></Icon>
                    </RouterLink>
                    <RouterLink to="" class="flex size-8 bg-default-200 rounded-md items-center justify-center hover:bg-primary/10 hover:text-primary transition-all text-default-600" aria-haspopup="dialog" aria-expanded="false" aria-controls="employeeEdit" data-hs-overlay="#employeeEdit">
                      <Icon icon="lucide:pencil" class="size-4"></Icon>
                    </RouterLink>
                    <RouterLink to="" class="flex size-8 bg-default-200 rounded-md items-center justify-center hover:bg-primary/10 hover:text-primary transition-all text-default-600" aria-haspopup="dialog" aria-expanded="false" aria-controls="employeeDelete" data-hs-overlay="#employeeDelete">
