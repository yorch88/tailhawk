                  ...
                  <tr class="text-default-800 font-normal" v-for="(item, idx) in leaves" :key="idx">
                    ...
                    <td class="px-3.5 py-2.5 whitespace-nowrap">
                      <div class="flex items-center gap-2">
                        <RouterLink to="" class="btn size-8 bg-default-200 hover:bg-default-600 hover:text-white text-default-600">
                          <Icon icon="lucide:pencil" class="size-4"></Icon>
                        </RouterLink>
                        <RouterLink to="" class="btn size-8 bg-success/15 hover:bg-success hover:text-white text-success">
                          <Icon icon="lucide:check" class="size-4"></Icon>
                        </RouterLink>
                        <RouterLink to="" class="btn size-8 bg-danger/10 hover:bg-danger hover:text-white text-danger" aria-haspopup="dialog" aria-expanded="false" aria-controls="hr-leave-delete-modal" data-hs-overlay="#hr-leave-delete-modal">
