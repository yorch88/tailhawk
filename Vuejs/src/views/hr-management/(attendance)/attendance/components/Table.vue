                  ...
                  <tr class="text-default-800 font-normal whitespace-nowrap" v-for="(item, idx) in attendances" :key="idx">
                    ...
                    <td class="px-3.5 py-3">
                      <div class="flex items-center gap-2">
                        <RouterLink to="" class="btn size-8 bg-success/10 hover:bg-success hover:text-white text-success">
                          <Icon icon="lucide:check" class="size-4"></Icon>
                        </RouterLink>
                        <RouterLink to="" class="btn size-8 bg-danger/10 hover:bg-danger hover:text-white text-danger">
