      ...
      <div class="bg-card/70 rounded-lg w-lg relative">
        <div class="text-center px-10 py-12">
          ...
          <form action="/" class="text-left w-full mt-10">
            ...
            <div class="mb-4">
              <RouterLink to="/cover-auth/reset-pass" class="text-primary font-medium text-sm mb-2 float-end">Forgot Password ?</RouterLink>
            ...
            <div class="flex w-full justify-center items-center gap-2">
              <RouterLink to="" class="btn bg-card border border-default-200 flex-grow hover:bg-default-150 shadow-sm hover:text-default-800">
            ...
            <div class="mt-10 text-center">
              <p class="text-base text-default-500">
                ...
                <RouterLink to="/cover-auth/register" class="font-semibold underline hover:text-primary transition duration-200">SignUp</RouterLink>
              </p>
            </div>
          </form>
        </div>
