        ...
        <div class="text-center px-10 py-12">
          ...
          <form action="/" class="text-left w-full mt-10">
            ...
            <div class="flex w-full justify-center items-center gap-2">
              <RouterLink to="" class="bg-card btn border border-default-200 flex-grow hover:bg-default-150 shadow-sm hover:text-default-800">
                <Icon icon="logog:google-icon" class="iconify-color"></Icon>
                Use Google
              </RouterLink>
              <RouterLink to="" class="bg-card btn border border-default-200 flex-grow hover:bg-default-150 shadow-sm hover:text-default-800">
            ...
            <div class="mt-10 text-center">
              <p class="text-base text-default-500">
                ...
                <RouterLink to="/cover-auth/login" class="font-semibold underline hover:text-primary transition duration-200"> Login</RouterLink>
              </p>
            </div>
          </form>
        </div>
