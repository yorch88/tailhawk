...
const isActive = computed(() => {
  const checkChildren = (children: MenuItemType[]): boolean => children.some((child) => (child.url && pathname.value.includes(child.url)) || (child.children && checkChildren(child.children)))
