          ...
          <div className="topbar-item hs-dropdown [--placement:bottom-right] relative inline-flex">
            ...
            <div className="hs-dropdown-menu" role="menu">
              {languages.map((lang, i) => <Link key={i} href="#" className="flex items-center gap-x-3.5 py-1.5 px-3 text-default-600 hover:bg-default-150 rounded font-medium">
                  <Image src={lang.src} alt={lang.label} className="size-4 rounded-full" />
                  {lang.label}
                </Link>)}
            </div>
          </div>
                    ...
                    {notifications[tab.id]?.map((n, j) => <Link key={j} href="#" className="flex gap-3 p-4 items-start hover:bg-default-150">
                        {n.avatar ? <div className="relative">
                            <div className="size-10 rounded-md bg-default-100 flex justify-center items-center">
                              <Image src={n.avatar} alt="avatar" className="rounded-md" />
                            </div>
          ...
          <div className="topbar-item hs-dropdown relative inline-flex">
            ...
            <div className="hs-dropdown-menu min-w-48">
              ...
              <div className="flex flex-col gap-y-1">
                {profileMenu.map((item, i) => item.divider ? <div key={i} className="border-t border-default-200 -mx-2 my-1"></div> : <Link key={i} href={item.href || '#!'} className="flex items-center gap-x-3.5 py-1.5 px-3 text-default-600 hover:bg-default-150 rounded font-medium">
                      {item.icon}
                      {item.label}
