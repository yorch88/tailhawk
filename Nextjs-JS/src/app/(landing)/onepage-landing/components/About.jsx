        ...
        <div className="flex flex-col lg:gap-y-20 gap-y-12">
          ...
          <div className="grid lg:grid-cols-12 gap-6 items-center lg:mt-12 mt-8">
            <div className="lg:col-span-6 lg:order-1 order-2">
              ...
              <Image src={widgets7} alt="" className="shadow-lg -mt-24 ms-auto lg:me-24 md:me-40 rounded-xl" />
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-6 items-center lg:mt-12 mt-8">
            ...
            <div className="lg:col-span-6">
              ...
              <Image src={widgets9} alt="" className="shadow-lg -mt-24 rounded-xl ms-auto lg:me-24 mr-40" />
            </div>
          </div>
        </div>
      </div>
