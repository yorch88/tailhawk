  ...
  return <footer className="relative md:pt-20 pt-12 md:pb-0 border-t border-default-200">
      ...
      <div className="container">
        <div className="grid grid-cols-12 md:gap-12 gap-6">
          <div className="lg:col-span-4 col-span-12">
            <div className="mb-5">
              <Link href="#">
                <Image src={logoDark} alt="logo dark" className="h-7 block dark:hidden" width={111} />
                <Image src={logoLight} alt="logo light" className="h-7 hidden dark:block" width={111} />
              </Link>
            </div>
            ...
            <div className="flex flex-wrap gap-3 md:mt-0 mt-5">
              ...
              icon: Icon,
              href
            }) => <Link key={id} href={href} className="size-10 flex items-center justify-center border border-default-200 bg-transparent rounded-full text-default-500 hover:text-primary transition">
      ...
      <div className="lg:py-10 py-6 mt-12 text-center text-default-500 text-base border-t border-default-200">
        <p>
          ...
          <Link href="https://themesdesign.in/" target="_blank" rel="noopener noreferrer" className="underline text-default-800 font-bold transition-all hover:text-primary">
            {developedBy}
          </Link>
        </p>
      </div>
