                  ...
                  {employeesData.map(emp => <tr key={emp.id} className="text-default-800 text-sm whitespace-nowrap">
                      ...
                      <td className="px-3.5 py-2.5 text-start">
                        <span className="inline-flex justify-start gap-2.5">
                          <Link href="#" className="btn size-8 bg-default-100 hover:bg-blue-100 text-default-600 hover:text-primary">
                            <LuPencil className="size-4" />
                          </Link>
                          <Link href="#" className="btn size-8 bg-default-100 hover:bg-red-100 text-default-600 hover:text-danger">
