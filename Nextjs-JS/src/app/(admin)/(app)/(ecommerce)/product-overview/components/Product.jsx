        ...
        <div className="card mb-5">
          <div className="card-body">
            <div className="grid md:grid-cols-3 grid-cols-1 gap-5 mb-5">
              <div className="md:col-span-2 grid-cols-1">
                <div className="rounded-md bg-default-100">
                  <Image src={overview01} alt="" />
                </div>
              </div>

              <div className="col-span-1">
                <div className="rounded-md bg-default-100 mb-5">
                  <Image src={overview02} alt="" />
                </div>
            ...
            <div className="grid grid-cols-2 gap-2 mt-4">
              <Link href="/cart" className="border border-primary w-full rounded btn text-primary hover:bg-primary/10 border-dashed">
            ...
            <div className="flex items-center gap-3 mt-3 justify-evenly">
              <Link href="#" className="flex items-center gap-1.25 text-default-700 text-sm transition-all duration-300 hover:text-primary">
