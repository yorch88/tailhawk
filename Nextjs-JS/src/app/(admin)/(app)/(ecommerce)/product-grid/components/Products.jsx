  ...
  return <div className="lg:col-span-3 col-span-1">
        ...
        <div className="flex gap-2 items-center">
          <div className="hs-dropdown relative inline-flex">
            ...
            <div className="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-40 card z-30 mt-2 p-2 text-sm" role="menu">
              <Link className="flex items-center gap-x-3.5 py-2 font-medium px-4 text-default-600 hover:bg-default-150 rounded" href="">
                Lowest Price
              </Link>
              <Link className="flex items-center gap-x-3.5 py-2 font-medium px-4 text-default-600 hover:bg-default-150 rounded" href="">
                Highest Price
      ...
      <div className="flex items-center mt-3 gap-3">
        <span className="flex items-center gap-1 rounded-full px-2.5 py-0.75 border border-default-200 text-xs">
          High to Low
          <Link href="#" className="align-middle transition-al duration-300">
        ...
        <Link href="#" className="py-0.75 px-2.5 text-xs rounded-md transition-all duration-300 hover:bg-default-150">
          All Clear
        </Link>
      </div>
              ...
              <div className="flex items-center gap-2 mt-4">
                ...
                <div className="hs-dropdown relative inline-flex">
                  ...
                  <div className="hs-dropdown-menu" role="menu">
                    <Link className="flex items-center gap-1.5 py-1.5 font-medium px-3 text-default-500 hover:bg-default-150 rounded" href="#">
