            ...
            <div className="flex flex-col justify-between h-full">
              <div className="mb-5 flex justify-between items-center gap-2">
                <div className="flex gap-2 items-center">
                  <div className="hs-dropdown relative inline-flex">
                    ...
                    <div className="hs-dropdown-menu" role="menu">
                      {['Personal', 'Business', 'Social', 'Home'].map(cat => <Link key={cat} href="#" className="flex items-center gap-x-3.5 py-1.5 font-medium px-3 text-sm text-default-600 hover:bg-default-150 rounded">
                          {cat}
                        </Link>)}
                    </div>
                  </div>
                ...
                <div className="hs-dropdown relative inline-flex">
                  ...
                  <div className="hs-dropdown-menu" role="menu">
                    <Link href="#" className="flex items-center gap-1.5 py-1.5 font-medium px-3 text-default-500 hover:bg-default-150 rounded">
