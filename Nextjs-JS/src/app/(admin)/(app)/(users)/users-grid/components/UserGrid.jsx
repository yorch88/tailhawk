        ...
        {users.map(user => <div key={user.id} className="card">
            <div className="card-body">
              <div className="relative flex items-center justify-center mx-auto text-lg rounded-full size-16 bg-default-100">
                {user.avatar ? <Image src={user.avatar} alt={user.name} className="rounded-full size-16" /> : <span>{user.initials}</span>}
              ...
              <div className="flex gap-2 mt-5">
                <Link href="/chat" className="btn border-primary text-primary hover:bg-primary hover:text-white flex-grow">
