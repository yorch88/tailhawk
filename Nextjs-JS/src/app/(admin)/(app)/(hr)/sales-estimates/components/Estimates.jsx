...
const Estimates = () => {
  ...
  return <div className="card">
      <div className="card-header flex justify-between items-center">
        ...
        <Link href="#" className="btn btn-sm bg-primary text-white flex items-center" aria-haspopup="dialog" aria-expanded="false" aria-controls="sales-estimates-add" data-hs-overlay="#sales-estimates-add">
