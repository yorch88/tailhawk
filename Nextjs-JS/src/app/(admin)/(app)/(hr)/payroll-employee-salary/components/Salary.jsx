...
const EmployeeRow = ({
  emp
    ...
    <td className="px-3.5 py-2.5 whitespace-nowrap text-sm">
      <Link href="#" className="flex items-center gap-3">
        <div className="rounded-full size-6 shrink-0 bg-default-100">
          <Image src={emp.image} alt={emp.name} className="h-6 rounded-full" />
        </div>
    ...
    <td className="px-3.5 py-2.5 whitespace-nowrap text-sm flex items-center gap-2">
      <Link href="/create-payslip" className="text-xs text-white bg-sky-500 transition-all duration-300 hover:bg-sky-600 rounded py-1.5 px-2">
        Generate Slip
      </Link>
      <div className="hs-dropdown relative inline-flex">
        ...
        <div className="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-40 card z-30 mt-2 p-2" role="menu">
          <Link className="flex items-center gap-1.5 py-1.5 font-medium px-3 text-sm text-default-500 hover:bg-default-150 rounded" href="#">
...
const Salary = () => {
  return <div className="card">
      <div className="card-header">
        ...
        <Link href="/create-payslip" className="btn btn-sm bg-primary text-white">
