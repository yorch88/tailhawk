                  ...
                  <tbody className="divide-y divide-default-200">
                    {leavesData.map(leave => <tr key={leave.id} className="text-default-800 font-normal whitespace-nowrap">
                        ...
                        <td className="px-3.5 py-2.5 flex items-center justify-end gap-2">
                          {leave.status === 'Pending' && <Link href="#" className="btn size-8 bg-default-200 hover:bg-default-600 hover:text-white transition-all text-default-600">
                              <LuPencil className="size-4" />
                            </Link>}
                          <Link href="#" className="btn size-8 bg-primary/20 hover:bg-primary text-primary hover:text-white">
