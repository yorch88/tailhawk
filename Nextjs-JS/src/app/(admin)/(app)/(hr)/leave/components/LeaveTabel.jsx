                    ...
                    {leaveData.map(leave => <tr key={leave.id} className="text-default-800 font-normal">
                        ...
                        <td className="px-3.5 py-2.5 whitespace-nowrap">
                          <div className="flex items-center gap-2">
                            <Link href="#" className="btn size-8 bg-default-200 hover:bg-default-600 hover:text-white text-default-600">
                              <LuPencil className="size-4" />
                            </Link>

                            <Link href="#" className="btn size-8 bg-success/15 hover:bg-success hover:text-white text-success">
                              <LuCheck className="size-4" />
                            </Link>

                            <Link href="#" className="btn size-8 bg-danger/10 hover:bg-danger hover:text-white text-danger" aria-haspopup="dialog" aria-expanded="false" aria-controls="hr-leave-delete-modal" data-hs-overlay="#hr-leave-delete-modal">
