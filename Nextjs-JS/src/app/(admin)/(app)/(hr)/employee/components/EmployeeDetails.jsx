                  ...
                  {employees.map(emp => <tr key={emp.id} className="text-default-800 font-normal whitespace-nowrap">
                      ...
                      <td className="px-3.5 py-3 text-sm">
                        <Link href="#" className="flex gap-3 items-center">
                          <Image src={emp.image} alt={emp.name} className="h-6 rounded-full" width={24} />
                      ...
                      <td className="px-3.5 py-3">
                        <div className="flex items-center gap-2">
                          <Link className="flex size-8 bg-default-200 rounded-md items-center justify-center hover:bg-primary/10 hover:text-primary transition-all text-default-600" href="#">
                            <LuEye className="size-3" />
                          </Link>
                          <Link className="flex size-8 bg-default-200 rounded-md items-center justify-center hover:bg-primary/10 hover:text-primary transition-all text-default-600" href="#" aria-haspopup="dialog" aria-expanded="false" aria-controls="employeeEdit" data-hs-overlay="#employeeEdit">
                            <LuSquarePen className="size-4" />
                          </Link>
                          <Link className="flex size-8 bg-default-200 rounded-md items-center justify-center hover:bg-primary/10 hover:text-primary transition-all text-default-600" href="#" aria-haspopup="dialog" aria-expanded="false" aria-controls="employeeDelete" data-hs-overlay="#employeeDelete">
