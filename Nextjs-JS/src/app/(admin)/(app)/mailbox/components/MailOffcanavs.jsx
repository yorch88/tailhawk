      ...
      <div className="card-header py-4">
        ...
        <div className="flex-grow">
          ...
          <p className="text-default-500 dark:text-zink-200">
            <Link href="#!">infrateach@tailwick.com</Link> (Aug 6, 2023, 9:04 PM)
          </p>
        </div>

        <div className="flex gap-3 shrink-0">
          <Link href="#!" className="flex items-center justify-center transition-all duration-200 ease-linear size-6 text-default-500 dark:text-zink-200 hover:text-primary dark:hover:text-primary">
            <LuArchiveRestore className="size-4" />
          </Link>
          <Link href="#!" className="flex items-center justify-center transition-all duration-200 ease-linear size-6 text-default-500 dark:text-zink-200 hover:text-sky-500 dark:hover:text-sky-500">
            <LuPrinter className="size-4" />
          </Link>
          <Link href="#!" className="flex items-center justify-center transition-all duration-200 ease-linear size-6 text-default-500 dark:text-zink-200 hover:text-yellow-500 dark:hover:text-yellow-500">
            <LuStar className="size-4" />
          </Link>
          <Link href="#!" className="flex items-center justify-center transition-all duration-200 ease-linear size-6 text-default-500 dark:text-zink-200 hover:text-danger dark:hover:text-danger">
        ...
        <div className="p-5 space-y-6">
          <div className="flex gap-3">
            <div className="relative flex items-center justify-center font-semibold rounded-full text-default-500 size-9 bg-default-100 shrink-0 dark:text-zink-200 dark:bg-zink-600">
              <Image src={avatar5} alt="" className="rounded-full h-9" />
            </div>
            ...
            <div className="grow">
              <div className="flex items-center">
                <div className="grow">
                  <h6>Infra Teach</h6>
                  <p className="text-default-500 dark:text-zink-200">
                    <Link href="#!">infrateach@tailwick.com</Link>
                  </p>
                </div>
          ...
          <div className="flex gap-3">
            <div className="relative flex items-center justify-center font-semibold bg-pink-100 rounded-full text-default-500 size-9 shrink-0 dark:bg-pink-500/20 dark:text-zink-200">
              <Image src={avatar1} alt="" className="rounded-full h-9" />
            </div>
            <div className="grow">
              <div className="flex items-center">
                <div className="grow">
                  <h6>Me</h6>
                  <p className="text-default-500 dark:text-zink-200">
                    <Link href="#!">paulakeenan@tailwick.com</Link>
                  </p>
                </div>
