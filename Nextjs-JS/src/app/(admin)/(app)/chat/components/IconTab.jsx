...
const IconTab = () => {
  return <div className="card-body flex flex-col justify-between">
      <Link href="#">
        <Image src={logoSm} alt="logo" className="h-8 mx-auto" width={32} />
      </Link>
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="hs-dropdown relative">
          <button type="button" className="hs-dropdown-toggle flex justify-center items-center" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown" hs-dropdown-placement="top-end">
            <Image src={avatar01} alt="avatar" className="rounded-md bg-pink-500/10 size-12 object-cover" />
          </button>

          <div className="hs-dropdown-menu" role="menu">
            <Link className="flex items-center gap-x-3.5 py-1.5 font-medium px-3 text-sm text-default-600 hover:bg-default-150 rounded" href="#">
              Logout
            </Link>
