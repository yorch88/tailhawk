            ...
            <div>
              <div className="relative before:absolute before:border-s-2 before:border-default-200 before:start-3.5 before:end-3.5 before:top-1.5 before:-bottom-1.5 pb-4">
                <div className="relative flex gap-2">
                  <Image src={avatar01} alt="" className="size-8 p-0.5 bg-card border rounded-full shrink-0 border-default-200" />
                  <div>
              ...
              <div className="relative before:absolute before:border-s-2 before:border-default-200 before:start-3.5 before:end-3.5 before:top-1.5 before:-bottom-1.5 pb-4">
                <div className="relative flex gap-2">
                  <Image src={avatar02} alt="" className="size-8 p-0.5 bg-card border rounded-full shrink-0 border-default-200" />
                  <div>
                    <h6 className="mb-1 text-sm text-heading font-semibold">
              ...
              <div className="relative before:absolute before:border-s-2 before:border-default-200 before:start-3.5 before:end-3.5 before:top-1.5 before:-bottom-1.5 pb-4">
                <div className="relative flex gap-2">
                  <Image src={avatar03} alt="" className="size-8 p-0.5 bg-card border rounded-full shrink-0 border-default-200" />
                  <div>
                    <h6 className="mb-1 text-sm text-heading font-semibold">
              ...
              <div className="relative">
                <div className="relative flex gap-2">
                  <Image src={avatar03} alt="" className="size-8 p-0.5 bg-card border rounded-full shrink-0 border-default-200" />
                  <div>
                    <h6 className="mb-1 text-sm text-heading font-semibold">New ticket received</h6>
                    <p className="mb-2 text-default-500">
                      User{' '}
