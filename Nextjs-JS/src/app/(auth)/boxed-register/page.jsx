...
const Page = () => {
  return <div className="bg-cover bg-no-repeat min-h-screen flex justify-center items-center" style={{
                    ...
                    <form className="text-left w-full mt-10">
                      ...
                      <div className="mt-10 text-center">
                        <p className="text-base text-default-500">
                          ...
                          <Link href="/boxed-login" className="font-semibold underline hover:text-primary transition duration-200">
                            Login
                          </Link>
                        </p>
                      </div>
                  ...
                  <div id="tabsForPhone" className="hidden" role="tabpanel" aria-labelledby="tabs-with-underline-item-2">
                    <form className="text-left w-full mt-10">
                      ...
                      <div className="mt-10 text-center">
                        <p className="text-base text-default-500">
                          Already have an account?{' '}
                          <Link href="/basic-login" className="font-semibold underline hover:text-primary transition duration-200">
                            Login
                          </Link>
                        </p>
                      </div>
            ...
            <div className="lg:col-span-7 bg-card/60 mx-2 my-2 shadow-[0_14px_15px_-3px_#f1f5f9,0_4px_6px_-4px_#f1f5f9] dark:shadow-none rounded-lg">
              <div className="pt-10 px-10 h-full">
                ...
                <div className="mt-auto">
                  <Image src={Boxed} alt="Illustration" />
                </div>
              </div>
            </div>
          </div>
