...
const Page = () => {
  return <div className="relative flex flex-row w-full overflow-hidden bg-gradient-to-r from-blue-900 h-screen to-blue-800 dark:to-blue-900 dark:from-blue-950">
        ...
        <div className="flex flex-col h-full w-full">
              ...
              <div className="mt-10 w-100 mx-auto">
                <div id="tabsForEmail" role="tabpanel" aria-labelledby="tabs-with-underline-item-1">
                  <form action="/index" className="text-left w-full mt-10">
                    ...
                    <div className="mb-4">
                      <Link href="/modern-reset-password" className="text-primary font-medium text-sm mb-2 float-end">
                        Forgot Password ?
                      </Link>
                    ...
                    <div className="mt-10 text-center">
                      <p className="text-base text-default-500">
                        ...
                        <Link href="/modern-register" className="font-semibold underline hover:text-primary transition duration-200">
                          {' '}
                          SignUp
                        </Link>
                      </p>
          ...
          <div className="mt-5 flex justify-center">
            <span className="text-sm text-default-500 flex gap-1">
              ...
              by{' '}
              <Link href="https://themesdesign.in/" target="_blank" rel="noopener noreferrer" className="text-default-800 hover:text-primary transition duration-200 underline">
                Themesdesign
              </Link>
            </span>
          </div>
