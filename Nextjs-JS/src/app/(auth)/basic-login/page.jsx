        ...
        <div className="card md:w-lg w-screen z-10">
          <div className="text-center px-10 py-12">
            ...
            <form action="/index" className="text-left w-full mt-10">
              ...
              <div className="mb-4">
                <Link href="/basic-reset-password" className="text-primary font-medium text-sm mb-2 float-end">
                  Forgot Password ?
                </Link>
              ...
              <div className="mt-10 text-center">
                <p className="text-base text-default-500">
                  ...
                  <Link href="/basic-register" className="font-semibold underline hover:text-primary transition duration-200">
                    SignUp
                  </Link>
                </p>
              </div>
