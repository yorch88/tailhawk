            ...
            <div className="lg:col-span-5">
              <div className="text-center px-10 py-12">
                ...
                <form action="/index" className="text-left w-full mt-10">
                  ...
                  <div className="mb-4">
                    <Link href="/boxed-reset-password" className="text-primary font-medium text-sm mb-2 float-end">
                      Forgot Password ?
                    </Link>
                  ...
                  <div className="flex w-full justify-center items-center gap-2">
                    <Link href="#" className="btn border border-default-200 flex-grow hover:bg-default-150 shadow-sm hover:text-default-800">
                  ...
                  <div className="mt-10 text-center">
                    <p className="text-base text-default-500">
                      ...
                      <Link href="/boxed-register" className="font-semibold underline hover:text-primary transition duration-200">
                        SignUp
                      </Link>
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="hs-dropdown [--placement:bottom-right] relative inline-flex">
                    ...
                    <div className="hs-dropdown-menu">
                      <Link href="" className="flex items-center gap-x-3.5 py-1.5 font-medium px-3 text-default-600 hover:bg-default-150 rounded">
                        <Image src={UsFlag} alt="US Flag" className="size-4 rounded-full" />
                        English
                      </Link>
                      <Link href="" className="flex items-center gap-x-3.5 py-1.5 font-medium px-3 text-default-600 hover:bg-default-150 rounded">
                        <Image src={SpainFlag} alt="Spain Flag" className="size-4 rounded-full" />
                        Spanish
                      </Link>
                      <Link href="" className="flex items-center gap-x-3.5 py-1.5 font-medium px-3 text-default-600 hover:bg-default-150 rounded">
                        <Image src={GermanyFlag} alt="Germany Flag" className="size-4 rounded-full" />
                        German
                      </Link>
                      <Link href="" className="flex items-center gap-x-3.5 py-1.5 font-medium px-3 text-default-600 hover:bg-default-150 rounded">
                        <Image src={FrenchFlag} alt="French Flag" className="size-4 rounded-full" />
                        French
                      </Link>
                      <Link href="" className="flex items-center gap-x-3.5 py-1.5 font-medium px-3 text-default-600 hover:bg-default-150 rounded">
                        <Image src={JapaneseFlag} alt="Japanese Flag" className="size-4 rounded-full" />
                        Japanese
                      </Link>
                      <Link href="" className="flex items-center gap-x-3.5 py-1.5 font-medium px-3 text-default-600 hover:bg-default-150 rounded">
                        <Image src={ItalyFlag} alt="Italy Flag" className="size-4 rounded-full" />
                        Italian
                      </Link>
                      <Link href="" className="flex items-center gap-x-3.5 py-1.5 font-medium px-3 text-default-600 hover:bg-default-150 rounded">
                        <Image src={RussiaFlag} alt="Russia Flag" className="size-4 rounded-full" />
                        Russian
                      </Link>
                      <Link href="" className="flex items-center gap-x-3.5 py-1.5 font-medium px-3 text-default-600 hover:bg-default-150 rounded">
                        <Image src={ArabianFlag} alt="Arabic Flag" className="size-4 rounded-full" />
                        Arabic
                      </Link>
                    </div>
                  </div>
