...
const Features = () => {
  return (
    <section id="Features" className="relative lg:pb-28 pb-10">
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 items-center">
            <div className="lg:w-lg">
              ...
              <Link href="#" className="btn text-primary text-base">
                Shopping Now<LuMoveRight className="size-4"/>
              </Link>
            </div>
            ...
            <div className="relative lg:mt-0 mt-6">
              ...
              <div className="md:ms-20">
                <Image src={Cta} alt="" className="w-lg relative inline-block" />
              </div>
            </div>
          </div>
        </div>
