...
const BirthdayCard = () => {
  return (
    <div className="relative mb-5 bg-gradient-to-r to-primary/50 from-transparent rounded-md shadow-md">
      <div className="absolute inset-0 opacity-30">
        <Image src={dashboardBg} alt="Dashboard background" fill className="object-cover" />
      </div>
      ...
      <div className="absolute bottom-0 right-0">
        <Image src={birthdayImg} alt="Birthday" />
      </div>
    </div>
  );
};
