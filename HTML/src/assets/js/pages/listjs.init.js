...
// import ListPagination from "list.pagination.js/dist/list.pagination.js";

// Register the plugin
// List.prototype.plugins(ListPagination);
...
xhttp.onload = function () {
    ...
    Array.from(json_records).forEach(raw => {
        customerList.add({
            id: '<a href="javascript:void(0);" class="font-medium link-primary id">#VZ' + raw.id + "</a>",
    ...
    customerList.remove("id", '<a href="javascript:void(0);" class="font-medium link-primary id">#VZ2101</a>');
}
    ...
    form.addEventListener('submit', function (event) {
        if (!form.checkValidity()) {
            ...
            if (
                ...
                customerList.add({
                    id: '<a href="javascript:void(0);" class="font-medium link-primary id">#VZ' + count + "</a>",
                ...
                Array.from(editValues).forEach(function (x) {
                    ...
                    if (selectedid == itemId) {
                        x.values({
                            id: '<a href="javascript:void(0);" class="font-medium link-primary id">' + idField.value + "</a>",
                            customer_name: customerNameField.value,
                            email: emailField.value,
                            date: dateField.value,
                            phone: phoneField.value,
    ...
    if (ids_array.length > 0) {
        if (confirm('Are you sure you want to delete this?')) {
            ids_array.forEach(function (id) {
                ...
                customerList.remove("id", `<a href="javascript:void(0);" class="font-medium link-primary id">${id}</a>`);
            });
